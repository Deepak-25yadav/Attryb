...
const AddDeal = () => {
  ...
  return (
    <Box borderRadius={4} boxShadow={cssStyles.boxShadow1} p={4} m="auto" width={["330px", "500px"]}>
      <Heading color="blue">Add New Product </Heading>
        ...
        <SimpleGrid gap={2}>
          ...
          <Flex flexDirection={["column","row"]} alignItems={"center"} justifyContent={"space-around"}>
            <Text
              ...
              pr={2}
              borderRadius={4}
              bg={!checkedOne.nameOfModel ? "purple" : "skyblue"}
              color="white"
            >
          ...
          <Input
            ...
            placeholder="No. of accidents reported"
          />
          <Input
            type="number"
            required
          ...
          />
          <ButtonMain loading={loading} type={"submit"} title={"Add New Car"} />
        </SimpleGrid>
      </form>
    </Box>
  );
