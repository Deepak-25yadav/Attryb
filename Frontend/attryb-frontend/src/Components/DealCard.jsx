...
const DealCard = ({
  ...
  return (
    ...
    >
      ...
      <Text >Car_Name {oemId && oemId.nameOfModel}</Text>
      <Text>Year : {oemId && oemId.yearOfModel}</Text>
      ...
      <Text>Max Speed {oemId && oemId.maxSpeed} km/hr</Text>
      <Text
        style={
      ...
      >
        Mielage {oemId && oemId.mileage} /ltr
      </Text>
      <Text>Power {oemId && oemId.power} HP</Text>
      <Text
        style={
          currentFilter === "price"
            ? {
